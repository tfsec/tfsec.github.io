---
title: AZU024
summary: RDP access should not be accessible from the Internet, should be blocked on port 3389 [azurerm_network_security_group azurerm_network_security_rule] 
resources: 
