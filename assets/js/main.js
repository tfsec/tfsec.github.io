...
(function (global, factory) {
    ...
    function plugin(UIkit) {
        ...
        UIkit.icon.add({
            ...
            digitalocean: '<svg viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" width="24" height="24" stroke="none" stroke-linecap="round" stroke-linejoin="round" fill="#0080ff" fill-rule="nonzero"><path d="M12.0014 23.9977v-4.6499c4.926 0 8.7494-4.875 6.858-10.0634-.7035-1.9273-2.2222-3.4455-4.1498-4.1482C9.5257 3.2597 4.641 7.0674 4.641 11.9911H0C0 4.1439 7.5929-1.9752 15.8249.595c3.6 1.1287 6.4634 3.9847 7.5787 7.5749C25.9761 16.4198 19.8658 24 12.0014 24z"/><path d="M7.3875 19.3605v-4.6237h4.6259v4.6237zM3.8227 22.923v-3.5625h3.5648v3.5625H3.8227zm0-3.5625H.843V16.383h2.9797v2.9775z"/></svg>'
        });
    }
