...
resources: [aws_redshift_security_group] 
permalink: /docs/aws/redshift/add-description-to-security-group/
redirect_from: 
  - /docs/aws//
---
...
The following example will fail the aws-redshift-add-description-to-security-group check.
...
The following example will pass the aws-redshift-add-description-to-security-group check.
