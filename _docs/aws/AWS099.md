---
title: AWS099 - IAM policy should avoid use of wildcards and instead apply the principle of least privilege
...
The following example will fail the AWS099 check.
...
The following example will pass the AWS099 check.
