...
shortcode: azure-compute-diable-password-authentication
legacy: 
...
permalink: /docs/azure/compute/diable-password-authentication/
redirect_from: 
  - /docs/azure//
---
...
The following example will fail the azure-compute-diable-password-authentication check.
...
The following example will pass the azure-compute-diable-password-authentication check.
