---
title: DIG004 - The load balancer forwarding rule is using an insecure protocol as an entrypoint
...
permalink: /docs/digitalocean/DIG004/
---
### Explanation
...
The following example will fail the DIG004 check.
...
The following example will pass the DIG004 check.
